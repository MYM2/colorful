...
# エンドユーザー
EndUser.create(email: 'a@a', password: 'aaaaaa', lastname_kanji: '阿部',firstname_kanji: '弘', lastname_kana: 'アベ',firstname_kana: 'ヒロシ',phone_number: '09011111111')
EndUser.create(email: 'b@b', password: 'bbbbbb', lastname_kanji: '馬場',firstname_kanji: '弘', lastname_kana: 'ババ',firstname_kana: 'ヒロシ',phone_number: '09022222222')
EndUser.create(email: 'c@c', password: 'cccccc', lastname_kanji: '両津',firstname_kanji: '勘吉', lastname_kana: 'リョウツ',firstname_kana: 'カンキチ',phone_number: '09033333333')
EndUser.create(email: 'd@d', password: 'dddddd', lastname_kanji: '金',firstname_kanji: '正恩', lastname_kana: 'キム',firstname_kana: 'ジョンウン',phone_number: '09044444444')
EndUser.create(email: 'e@e', password: 'eeeeee', lastname_kanji: '江田',firstname_kanji: '弘', lastname_kana: 'エダ',firstname_kana: 'ヒロシ',phone_number: '09055555555')
EndUser.create(email: 'f@f', password: '', lastname_kanji: '',firstname_kanji: '', lastname_kana: '',firstname_kana: '',phone_number: '')
EndUser.create(email: '', password: '', lastname_kanji: '',firstname_kanji: '', lastname_kana: '',firstname_kana: '',phone_number: '')
EndUser.create(email: '', password: '', lastname_kanji: '',firstname_kanji: '', lastname_kana: '',firstname_kana: '',phone_number: '')
EndUser.create(email: '', password: '', lastname_kanji: '',firstname_kanji: '', lastname_kana: '',firstname_kana: '',phone_number: '')
# ジャンル
